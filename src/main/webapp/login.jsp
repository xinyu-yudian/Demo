	...
	<div class="container" id="top">
		<div class="row" style="margin-top: 280px; ">
			...
			<div class="col-md-4" id="login-box">
				...
				<%--<img src="images/logo.jpg"style="width: 40px;height: 40px">--%>	<p style="margin-left: 100px"><h3 style="margin-left:70px ; margin-top: -10px">高校选课系统</h3></p>
				  <div class="form-group">
				    <label for="firstname" class="col-sm-3 control-label">用户名</label>
				    <div class="col-sm-9">
				      <input type="text" class="form-control" id="userID" placeholder="请输入用户名" name="username">
				    </div>
				  </div>
				  <div class="form-group">
